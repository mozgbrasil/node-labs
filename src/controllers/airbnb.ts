 ...
 */
async function findOneListingByName(client: any, nameOfListing: any) {
  ...
  (function () {
    async function main() {
      ...
      try {
        ...
        return await findListingsWithMinimumBedroomsBathroomsAndMostRecentReviews(
          client,
          {
    ...
    main()
      .then((ret) => {
        ...
        res.render("tests/airbnb", options);
      })
      .catch(console.error);
  })();
